...
Users can download the fillable ICEMAN form for [RCTs](../files/iceman-rct-form.docx) or [meta-analyses](../files/iceman-meta-analysis-form.docx), complete it on their device, and attach it to the appendix of their publication. Alternatively, the [online tool](../tool.qmd) generates a downloadable reporting table directly.
