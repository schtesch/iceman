...
**Does the analysis suggest possible effect modification? (interaction p < 0.1)?** Do not apply ICEMAN if the interaction p-value is 0.1 or larger, i.e., provides very little statistical support for the existence of an effect modification. ICEMAN is designed to address the possible claim (presence) of an effect modification rather than the claim of no effect modification (absence).
